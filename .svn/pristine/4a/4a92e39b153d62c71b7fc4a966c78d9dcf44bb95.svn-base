...
<html>
	...
	<head>
		...
		websocket.onmessage = function(event) {
			...
			$("#content").append("<br><br><br><br><div style='text-align: center;'>"+new Date().Format("hh:mm:ss")+"</div><div class='sender'><div><img src='img/IMG_1774.JPG' class='img-circle'></div><div><div class='left_triangle'></div><span>"+data.text+"</span></div></div>");
			scrollToBottom();
		};
		...
		websocket.onclose = function(event) {
			...
			function sendMsg(){
				...
				if(v==""){
					...
					$("#content").append("<br><br><br><br><div style='text-align: center;'>"+new Date().Format("hh:mm:ss")+"</div><div class='receiver'><div><img src='img/doctoeimg.jpg' class='img-circle'></div><div><div class='right_triangle'></div><span>"+data.text+"</span></div></div>");					scrollToBottom();
					clearAll();
				}
			}
			...
			<div class="row">
				<div class="col-lg-12" style="margin-top: 50px;">
					...
					<div class="chat-input col-lg-6 col-lg-offset-3" style="padding: 0px;">
						<textarea style="overflow-x:hidden; overflow-y: auto; resize: none; width:100%;" cols="78" rows="4"  onkeydown="send(event);" id="msg" class="msg"></textarea>
						<div>
